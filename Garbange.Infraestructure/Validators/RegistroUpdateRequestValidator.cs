...
{
    public class RegistroUpdateRequestValidator : AbstractValidator<RegistroUpdateRequest>
    {
        private readonly IRegistroRepository _repository;

        public RegistroUpdateRequestValidator(IRegistroRepository repository)
        {
